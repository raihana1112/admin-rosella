...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav navbar-dark sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #cc0099;">
            ...
            <li class="nav-item">
                <a class="nav-link" href="View/list-produk.php">
                    <i class="fas fa-fw fa-list"></i>
                    <span>List Produk</span></a>
            </li>
            
            <li class="nav-item">
                <a class="nav-link" href="View/tambah-produk.php">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <p>Bunga rosella merupakan bunga yang dihasilkan oleh tanaman rosella (Hibiscus sabdariffa). Tanaman ini dikenal juga sebagai roselle dalam bahasa Inggris atau karkade dalam bahasa Arab. Bunga rosella memiliki ciri khas berwarna merah tua hingga ungu, dan biasanya digunakan dalam berbagai keperluan, baik untuk konsumsi langsung maupun sebagai bahan baku dalam industri makanan dan minuman.
                                        <br> <br>
                                        Bunga rosella sering digunakan untuk membuat minuman dingin atau panas. Misalnya, di beberapa negara, bunga rosella direndam dalam air panas untuk membuat teh rosella yang kaya akan vitamin C dan antioksidan.
                                    </p>
                                    <p class="mb-0">
                                    Official Store <br>
                                    Ulee Kareng, Banda Aceh <br> <br>

                                    Contact Info :<br>
                                    Whatsapp  : 0822-4112-4032 <br>
                                    Instagram : @rosella.aceh<br>
                                    Email     : rosellaaceh@gmail.com
                                    </p>
                                </div>
                            </div>
                        </div>
