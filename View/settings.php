...
<ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown no-arrow">
            ...
            <a class="dropdown-item" href="login.php" data-toggle="modal" data-target="#logoutModal">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Setting Account</h1>
                        
                    </div>
                <div class="card-body">
                                                    <form method="GET" action="aksi/edit-akun.php">
                                                    <input type="hidden" name="id" value="<?php echo $d['id']; ?>">
                                                        <div class="form-group row">
                                                            <div class="col-sm-3 mb-3 mb-sm-0"><label required>Nama</label>
                                                            <input class="form-control form-control-solid" name="nama" value="<?php echo $d['nama']; ?>" type="text">
                                                            </div>
                                                            
                                                            <div class="col-sm-3 mb-3 mb-sm-0"><label>Username</label><input class="form-control form-control-solid" name="username" value="<?php echo $d['username']; ?>" type="text"></div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-sm-3 mb-3 mb-sm-0"><label>Password</label><input class="form-control form-control-solid" name="password" value="<?php echo $d['password']; ?>" type="text"></div>
        ...
        ?>
                                                        <input type="submit" value="Ubah data akun" class="btn btn-success" style="float: left;">
