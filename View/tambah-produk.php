    ...
    ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Tambah Data Produk Rosella Aceh</h1>
                 ...
                 <div class="card-body">
                                                     ...
                                                     <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-4 mb-3 mb-sm-0"><label>Foto Produk</label> 
                                                                <input class="form-control ps-0" type="file" name="file">
                                                            </div>
                                                            <div class="col-sm-3 mb-3 mb-sm-0"><label>Nama Produk</label><input class="form-control form-control-solid" name="nama_produk" type="text" required></div>
</div>
<div class="form-group row">
                                                            <div class="col-sm-4 mb-3 mb-sm-0"><label>Keterangan Produk</label>
                                                            <textarea rows="4" name="keterangan" class="form-control form-control-solid" required></textarea>
                                                            </div>
                                                            <div class="col-sm-3 mb-3 mb-sm-0"><label>Harga Produk</label><input class="form-control form-control-solid" name="harga" type="text" required>
